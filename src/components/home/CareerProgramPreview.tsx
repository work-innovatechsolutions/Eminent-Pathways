      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden border-2 border-brand-gold/30 shadow-2xl bg-brand-navy-800">
              ...
              <div className="p-4 bg-brand-navy-950 border-t border-slate-800 text-center">
                <span className="text-xs font-semibold text-brand-gold-light uppercase tracking-wider block">
                  Official Initiative Creative
                </span>
